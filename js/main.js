  ...
  function checkFiles(files) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      setTimeout(() => {
        ...
        addFileDetailsToDiv(currentFile.name, isSafe, currentFile.size, currentFile.type, new Date());
  ...
  function generateResultHTML(isSafe, fileName) {
    ...
    const resultImage = isSafe ? "./images/true.png" : "./images/false.png";
  ...
  function updateSubmitButton() {
    setTimeout(() => {
      submitBtn.innerHTML = '<a href="details.html">Show Details</a>';
    }, 0);
  }
